...
public class pore_delete1 extends android.support.v4.app.Fragment {
    @Nullable
    @Override
...
//        };
        ...
        //ActionBar.NAVIGATION_MODE_TABS is depricated and producing a lot of issues, so i chose pagerSlidingTabStrip instead
